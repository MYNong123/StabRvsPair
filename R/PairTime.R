...
#' @export
#'
#' @examples testRunTime(ControlFrame,TreatFrame,HighPercent=0.9,LowPercent=0.1)
testRunTime<-function(ControlFrame,TreatFrame,HighPercent=0.9,LowPercent=0.1){
  ...
  print(paste0("Treat:The calculation time takes ",round(Time2[3]*nrow(TreatFrame))/3600," hours."))
