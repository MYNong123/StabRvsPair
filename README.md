...
PairTime=testRunTime(Normal,Tumor,0.9,0.1) #Test the running speed of the computer.
#Here, 0.9 and 0.1 represent the proportion of HighPercent and LowPercent expressed in the sample, indicating that 90% of the samples of this gene are larger than the normal group. The default value is 0.9, which can also be set to 0.95.

GetPair=FindStabRvsPair(Normal,Tumor,0.9,0.1) #get REOs
